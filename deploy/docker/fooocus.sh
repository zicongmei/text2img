# # Create a dedicated directory on your host machine
# mkdir -p $HOME/fooocus_data

# docker run -d \
#     --name fooocus \
#     --gpus all \
#     -p 7860:7860 \
#     -v $HOME/fooocus_data/models:/fooocus/models \
#     -v $HOME/fooocus_data/outputs:/fooocus/outputs \
